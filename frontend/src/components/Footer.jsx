        ...
        <div className="footer-content">
          ...
          <div className="footer-section">
            ...
            <div className="social-links">
              <a href="https://www.instagram.com/elburritoloko/" target="_blank" rel="noopener noreferrer" aria-label="Instagram" className="social-link">
                <Instagram size={24} />
              </a>
              <a href="https://www.facebook.com/elburritoloko" target="_blank" rel="noopener noreferrer" aria-label="Facebook" className="social-link">
                <Facebook size={24} />
              </a>
              <a href="#" aria-label="TikTok" className="social-link social-disabled">
